...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Paradise Scrap")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "PScrap")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/ParadiseScrapbot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/ParadiseScrapbot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With 🍃 By @Nopegoodloking")
